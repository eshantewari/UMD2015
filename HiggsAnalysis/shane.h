...
// Thu Jul 30 13:11:33 2015 by ROOT version 5.32/00
// from TTree HZZ4LeptonsAnalysis/HZZ4Leptons Analysis Tree
// found on file: mainZZ.root
//////////////////////////////////////////////////////////
...
#ifdef shane_cxx
shane::shane(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("mainZZ.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("mainZZ.root");
      }
...
Int_t shane::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t shane::LoadTree(Long64_t entry)
{
...
void shane::Show(Long64_t entry)
{
...
Int_t shane::Cut(Long64_t entry)
{
